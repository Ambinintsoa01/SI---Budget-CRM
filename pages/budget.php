...
<head>
    ...
    <title><?= $viewMode ? 'Détails du Budget' : 'Création de Budget' ?> - Gestion Budgétaire</title>
...
<body>
    ...
    <div class="main-content">
        <header>
            <h1><?= $viewMode ? 'Détails du Budget' : 'Création de Budget' ?> - <?= htmlspecialchars($currentDepartment['name']) ?></h1>
